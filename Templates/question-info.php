		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default" id="correctAnswer">
					<a href="../profile" class="list-group-item">User 1</a>
					<div class="panel-body">Answer 1</div>
				</div>
				<div class="panel panel-default" id="answerComment">
					<a href="../profile" class="list-group-item">User 3</a>
					<div class="panel-body">I agree!</div>
				</div>
				<div class="panel panel-default">
					<a href="../profile" class="list-group-item">User 2</a>
				...
				<div class="panel panel-default" id="answerComment">
					<a href="../profile" class="list-group-item">User 5</a>
					<div class="panel-body">I agree!</div>
				</div>
				<div class="panel panel-default">
					<a href="../profile" class="list-group-item">User 4</a>
